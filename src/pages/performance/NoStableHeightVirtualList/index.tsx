...
const LOREM = [
  ...
  '这是一段超级长的文本内容！' +
    '此处省略一万字...'.repeat(10) +
    '由于文本非常长，它会撑开容器的高度，导致后续元素的 Top 坐标发生偏移。我们的 ResizeObserver 必须能够捕捉到这种变化并实时修正 Spacer 的高度。',
  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      <Typography style={{ marginBottom: 24 }}>
        ...
        <Paragraph>
          这是最高难度的虚拟列表实现。难点在于：<Text code>Item</Text>{' '}
          的高度在渲染前是未知的，甚至在渲染后会因为图片加载、 文字展开而动态变化。本示例通过{' '}
          <Text strong>ResizeObserver + 坐标平移纠偏</Text> 算法，实现了 0
          闪烁、高性能的动态高度列表。
        </Paragraph>
      </Typography>
